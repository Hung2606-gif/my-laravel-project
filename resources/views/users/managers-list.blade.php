...
<div class="flex">
    ...
    <div class="flex-1 px-6 pt-6">
        <h2 class="text-2xl font-bold mb-4">Danh sách Quản lí</h2>

        <form method="GET" action="{{ route('users.managers') }}" class="mb-4 flex items-center">
        ...
        <table class="w-full border text-left">
            ...
            <tbody>
                    ...
                    <tr class="border-t" data-id="{{ $user->id }}">
                        ...
                        <td class="border px-4 py-2 text-center">
                            <div class="flex justify-center gap-2">
                                ...
                                <form method="POST" action="{{ route('users.destroy', $user->id) }}" onsubmit="return confirm('Bạn có chắc chắn muốn xoá người dùng này?')">
                                    @csrf
                                    @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center py-4">Không có quản lý nào được tìm thấy.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
