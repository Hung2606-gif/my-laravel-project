            ...
            <div class="card-body">
                <form action="{{ route('reports.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="report_name" id="report_name" class="form-control" value="{{ old('report_name') }}" required>
                    </div>

                    <div class="form-group">
                        <label for="report_date">Ngày thực hiện</label>
                        <input type="date" name="report_date" id="report_date" class="form-control" value="{{ old('report_date') }}">
                    </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="decimal" name="working_hours" id="working_hours" class="form-control" value="{{ old('working_hours') }}" required>
                    </div>
